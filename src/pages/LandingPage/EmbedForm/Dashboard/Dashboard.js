...
const Dashboard = ({selectedFilters, setSelectedFilters,filterOptions,dateFilterOptions,fieldOptions,isFetchingLookmlFields,selectedDateFilter, setSelectedDateFilter}) => {
  ...
  return (
    ...
    {isPageLoading ? (
      ...
      <div className="slideOutTab3">
        <div id="one3" className="openTab bottomShadow" role="button" tabindex="0" onClick={() => setShow3(true)}>
          ...
          <p className="m-0"><span className="noMobile">Purchases Filters</span></p>
        </div>
      </div>
    ...
    <div className="modal-footer">
      ...
      <Col xs={12} md={5}>
          ...
          <p className="mt-5">Total Spend: <span className="highlight large">$3,298</span></p>
      </Col>
